...
class TimeClassVisitor(classVisitor: ClassVisitor, val times: List<TimeBean>) :
    ...
    override fun visitMethod(
        ...
        if (isAbstractMethod || isNativeMethod || isInterface || methodVisitor == null || "<init>" == name || "<cinit>" == name) {
